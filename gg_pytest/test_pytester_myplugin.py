...
def test_simple_pytester_example(pytester: pytest.Pytester):
    ...
    # Step 2: Run pytest on the created test file
    result = pytester.runpytest()

    # Step 3: Assert that the test passed
...
# def test_deprecated_usage(pytester):
#     pytester.makepyfile("""
#         import warnings
